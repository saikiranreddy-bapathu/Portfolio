  ...
  return (
    <header className="relative flex justify-between items-center px-6 py-6 z-50 no-print flex-shrink-0 w-full max-w-7xl mx-auto">
      ...
      <div className="flex items-center space-x-4 cursor-pointer group" onClick={() => handleNavClick('hero')}>
        ...
        <div className="flex items-center px-3 md:px-4 py-1.5 md:py-2 bg-slate-900/40 backdrop-blur-xl border border-white/10 rounded-full shadow-[0_0_15px_rgba(0,0,0,0.5)] group-hover:bg-slate-800/50 transition-colors duration-300">
          <span className="text-[10px] md:text-[15px] font-medium tracking-wide uppercase text-slate-200">
            Sai Kiran Reddy <span className="text-slate-500 mx-1 md:mx-2">/</span> <span className="text-[#00E5FF]/90">Software Developer</span>
          </span>
        </div>
      </div>
